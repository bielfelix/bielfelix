...
A current Laravel 13 and PostgreSQL 17 rebuild of an older PHP project.
...
- transactional enrollment rules
- row locking for capacity consistency
...
The older implementation remains public separately so the engineering progression stays visible.

### [REST API in PHP without a framework](https://github.com/bielfelix/api-rest-php-sem-framework)

A historical backend project built directly with PHP and MySQL.

It covers routing, PDO, repositories, services, validation, bearer authentication and JSON APIs without relying on a framework.
